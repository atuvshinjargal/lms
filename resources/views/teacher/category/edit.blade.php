...
@section('content')
  <div class="container-fluid">
    <div class="row page-title-row">
      <div class="col-md-12">
        <h3>{{$lesson->name}} <small>» хичээлийн {{$name}} задаргааг засах</small></h3>
      </div>
    </div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" method="POST"
                  action="{{ route('teacher.{lesson}.category.update', array($lesson->id,$id)) }}">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
              <input type="hidden" name="_method" value="PUT">

              @include('teacher.category._form')
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <form method="POST" action="{{ route('teacher.{lesson}.category.destroy', array($lesson->id, $id)) }}">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
